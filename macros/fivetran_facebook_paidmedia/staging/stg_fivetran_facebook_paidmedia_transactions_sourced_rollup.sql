{% macro create_stg_fivetran_facebook_paidmedia_transactions_sourced_rollup(
    source_name="src_fivetran_facebook_paidmedia",
    source_table="ads_insights",
    extract_fields="stg_fivetran_facebook_paidmedia_extract_fields_from_adcreative_parameterized"
) %}
    select
