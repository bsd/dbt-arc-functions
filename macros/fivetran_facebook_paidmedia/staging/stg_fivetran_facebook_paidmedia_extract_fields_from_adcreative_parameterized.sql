{% macro create_stg_fivetran_facebook_paidmedia_extract_fields_from_adcreative_parameterized(
    campaign_regex,
    objective_regex,
    audience_regex,
    source_adcreative_name="src_fivetran_facebook_paidmedia",
    source_adcreative_table_name="adcreative",
    source_ads_name="src_fivetran_facebook_paidmedia",
