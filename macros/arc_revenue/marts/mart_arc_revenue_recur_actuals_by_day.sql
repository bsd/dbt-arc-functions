...
CASE
    WHEN REGEXP_CONTAINS(join_amount_string,"0[-]25") THEN 1
    WHEN REGEXP_CONTAINS(join_amount_string,"26[-]100") THEN 2
    WHEN REGEXP_CONTAINS(join_amount_string,"101[-]250") THEN 3
    WHEN REGEXP_CONTAINS(join_amount_string,"251[-]500") THEN 4
    WHEN REGEXP_CONTAINS(join_amount_string,"501[-]1000") THEN 5
    WHEN REGEXP_CONTAINS(join_amount_string,"1001[-]10000") THEN 6
    WHEN REGEXP_CONTAINS(join_amount_string,"10000+") THEN 7
