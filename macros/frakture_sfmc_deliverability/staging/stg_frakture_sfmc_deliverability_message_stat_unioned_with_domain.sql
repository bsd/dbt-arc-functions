{% macro create_stg_frakture_sfmc_deliverability_message_stat_unioned_with_domain(
    deliverability_stat="stg_frakture_sfmc_deliverability_message_stat_unioned",
