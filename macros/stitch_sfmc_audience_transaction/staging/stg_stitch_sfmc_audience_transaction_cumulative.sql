...
select
    ...
    sum(amount) over (
        ...
        order by
            transaction_date range between interval 30 day preceding and current row
    ...
    sum(amount) over (
        partition by person_id
        order by
            transaction_date range between interval 6 month preceding and current row
    ...
    sum(amount) over (
        partition by person_id
        order by
            transaction_date range between interval 12 month preceding and current row
    ...
    sum(amount) over (
        partition by person_id
        order by
            transaction_date range between interval 24 month preceding and current row
