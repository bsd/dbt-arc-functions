    ...
    with
        ...
        filtered_changes as (
            ...
            select
                ...
                case
                    when donor_audience in ('Prospect Existing', 'Prospect New') then
                        -- For 'Prospect Existing' and 'Prospect New', adjust end_date to be the day before the next transaction
                        -- Ensure this logic applies correctly by adjusting it to work with the grouped dataset
