...
with transactions as (select person_id, transaction_id, transaction_date from {{ref(transactions)}}),

audience as (select transaction_id, donor_audience, channel, amount from {{ref(audience)}}),
