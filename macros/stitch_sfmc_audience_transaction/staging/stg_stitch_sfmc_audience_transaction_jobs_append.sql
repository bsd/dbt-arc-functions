    ...
    with
        ...
        (
            select distinct
                ...
                case
                    when
                        cumulative_amount_30_days_recur > 0  -- confirmed by laura to leave?
                    ...
                    when
                        ...
                        and daily_revenue >= 80
                    -- what if someone gave more than 24999 in 24 months but not in 12
                    -- months? won't fit into major OR recurring Or mass!!!
                    then 'Leadership Giving'
                    -- midlevel = cumulative $1,000 - $24,999 over 24 months
                    -- (including all gifts)
                    when cumulative_amount_24_months_non_recur < 1000
                    then 'Mass'
                    -- mass = non-recurring; $1-$999; not monthly, midlevel, major, or
                    -- unite
                    else null
