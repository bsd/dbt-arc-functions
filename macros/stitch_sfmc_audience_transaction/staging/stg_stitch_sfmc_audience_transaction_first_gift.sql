...
with first_transactions as (
    ...
    select
        ...
        ( case 
            when first_transactions.first_gift_amount_int between 0 and 25
            then '0-25'
            when first_transactions.first_gift_amount_int between 26 and 100
            then '26-100'
            when first_transactions.first_gift_amount_int between 101 and 250
            then '101-250'
            when first_transactions.first_gift_amount_int between 251 and 500
            then '251-500'
            when first_transactions.first_gift_amount_int between 501 and 1000
            then '501-1000'
            when first_transactions.first_gift_amount_int between 1001 and 10000
            then '1001-10000'
            else '10000+'
        end
    ...
    (
        case
            when first_transactions.first_gift_amount_int between 0 and 10
            then '0-10'
            when first_transactions.first_gift_amount_int between 11 and 20
            then '11-20'
            when first_transactions.first_gift_amount_int between 21 and 30
            then '21-30'
            when first_transactions.first_gift_amount_int between 31 and 40
            then '31-40'
            when first_transactions.first_gift_amount_int between 41 and 50
            then '41-50'
            when first_transactions.first_gift_amount_int between 51 and 60
            then '51-60'
            when first_transactions.first_gift_amount_int between 61 and 70
            then '61-70'
            when first_transactions.first_gift_amount_int between 71 and 80
            then '71-80'
            when first_transactions.first_gift_amount_int between 81 and 90
            then '81-90'
            when first_transactions.first_gift_amount_int between 91 and 100
            then '91-100'
