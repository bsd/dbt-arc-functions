...
*/
    with
        first_transactions as (
            select person_id, min(transaction_date_day) as first_transaction_date
    ...
    join
        ...
        on first_transactions.person_id = transactions.person_id
        and first_transactions.first_transaction_date
        = transactions.transaction_date_day
    join
        {{ ref(audience) }} audience
        on first_transactions.person_id = audience.person_id
        and first_transactions.first_transaction_date = audience.transaction_date_day
