...
select 
base.*,
(total_donors / (case when activation = 'Act00' then total_donors end)) as retention_rate,
(total_revenue_cumulative_cohort/case when activation = 'Act00' then total_donors end) as value_per_donor
from base
{% endmacro %}
