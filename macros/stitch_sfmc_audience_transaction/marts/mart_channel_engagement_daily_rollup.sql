...
select
    ...
    count(case when donor_engagement = 'active' then person_id end) as active_donors,
    count(case when donor_engagement = 'lapsed' then person_id end) as lapsed_donors,
