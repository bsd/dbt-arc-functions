{% macro create_mart_audience_1x_activation(
    second_gift_by_cohort="stg_audience_transaction_onetime_second_gift_by_cohort",
    rev_by_cohort="stg_audience_transaction_onetime_rev_by_cohort",
    first_gift_explode="stg_audience_transaction_onetime_first_gift_by_cohort"
) %}
