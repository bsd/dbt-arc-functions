...
def main(dbt_base_path):
    # Check if dbt is installed on the system
    try:
        subprocess.run(["dbt", "--version"], check=True)
    except subprocess.CalledProcessError:
        click.echo("Error: dbt command not found. Please install dbt before running this script.")
        return
